...
class whaledr(object):
    def __init__(self):
        ...
        self.WHALE_PATH = 'train_images/whale'
        self.NON_WHALE_PATH = 'train_images/non_whale'
        self.PREFIX = 'megaptera'
        self.START_LEN = len(self.PREFIX.split('/')[0]) + 1
        self.WHALE_LOOKUP_FILE = 'megaptera-13ae9-sampleSummary-export.json'
        ...
        self.BATCH_SIZE = 16
        self.EPOCS = 10
        self.MODEL_WEIGHT_CHECKPOINT_PATH = 'model_weights'
    ...
    def data_prep(self):
        ...
        self.whale_images = list(self.PREFIX + self.LOOKUP_DELIMITER +final_data[(final_data['num_votes'] != 0) & (final_data['avg_score'] > 0)]['image_id'])
        self.non_whale_images = list(self.PREFIX + self.LOOKUP_DELIMITER +final_data[(final_data['num_votes'] != 0) & (final_data['avg_score'] == 0)]['image_id'])
